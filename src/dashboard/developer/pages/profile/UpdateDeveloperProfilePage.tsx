...
import type { UpdateDeveloperProfileInput } from "../../actions/update-developer-profile.action";
import { useParams } from "react-router";
import { useUpdateDeveloperProfile } from "../../hooks/useUpdateDeveloperProfile";
import { useGetDeveloperProfileById } from "../../hooks/useGetDeveloperProfileById";

export const UpdateDeveloperProfilePage = () => {
  const { id } = useParams();
  const { data: profile } = useGetDeveloperProfileById(id!);
  ...
  const updateProfile = useUpdateDeveloperProfile(id!);
